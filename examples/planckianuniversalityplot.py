...
def main():
    ...
    emd_shearlenghtfig = QuantityQuantityPlot("one_over_A", "shear_length", EMD, quantity_multi_line="temperature",
                                          mask1=emd_highAmask * emd_custom_mask * emd_Tmask, linelabels=True, cbar=False)
    ...
    emd_sigmaTfig = QuantityQuantityPlot("temperature", "conductivity_T", EMD, quantity_multi_line="lattice_amplitude",
                                     mask1=Anot0_emd*emd_custom_mask*(EMD.temperature>0.0089))
    ...
    rn_sigmaTfig = QuantityQuantityPlot("temperature", "conductivity_xx", RN, quantity_multi_line="lattice_amplitude",
                                        mask1=Anot0_rn)
    rn_sigmaTfig.ax1.set_ylim(ymin=0, ymax=75)
